...
object JavaEngine {
    ...
    fun initNameSpace(nameSpace: NameSpace, plugin: JavaPlugin) {
        nameSpace.apply {
            ...
            // unsupported pl-only services remain null instead of being fabricated.
            setVariable("startedAt", java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss", java.util.Locale.US).format(java.util.Date()))
            setVariable("FieldClass", java.lang.reflect.Field::class.java)
            setVariable("MethodClass", java.lang.reflect.Method::class.java)
            setVariable("ConstructorClass", java.lang.reflect.Constructor::class.java)
            setVariable("ConsumerClass", Consumer::class.java)
            setVariable("FunctionClass", Function::class.java)
            setVariable("JavaHookApiClass", JavaHookApi::class.java)
            setVariable("WeApiClass", WeApi::class.java)
            setVariable("WeMessageApiClass", WeMessageApi::class.java)
            setVariable("WeContactApiClass", WeContactApi::class.java)
            setVariable("WeGroupApiClass", WeGroupApi::class.java)
            setVariable("WeDatabaseApiClass", WeDatabaseApi::class.java)
            setVariable("WeServiceApiClass", WeServiceApi::class.java)
            setVariable("apis", null)
            setVariable("dexKit", null)
            ...
            setVariable("waBridge", scriptApi)
            setVariable("http", scriptApi)
